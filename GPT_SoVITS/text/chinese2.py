...
import folder_paths
G2PMODEL_PATH=os.path.join(folder_paths.models_dir,"GPT_SoVITS/G2PWModel")
bert_path=os.path.join(folder_paths.models_dir,"GPT_SoVITS/chinese-roberta-wwm-ext-large")
...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(model_dir=G2PMODEL_PATH,model_source=bert_path,v_to_u=False, neutral_tone_with_five=True)
