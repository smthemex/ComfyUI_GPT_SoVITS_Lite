...
def download_and_decompress(model_dir):
    if not os.path.join(model_dir):
        #parent_directory = os.path.dirname(model_dir)
        parent_directory=os.path.join(folder_paths.models_dir, "GPT_SoVITS")
...
class G2PWOnnxConverter:
    def __init__(self,
                 model_dir:str= os.path.join(folder_paths.models_dir,"GPT_SoVITS/G2PWModel"),
                 style: str='bopomofo',
